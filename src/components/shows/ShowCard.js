        ...
        <div className="col showCard">
            <div className="card ">
                <Link to={`/shows/${show.show_id}`} title={show.show_name} >
                    <img src={show.show_img_url} className="card-img-top" alt={show.show_name} />
                </ Link>
            ...
            <div className="card-body row">
                ...
                {
                    (show.id === 2) && (
                        <img className="col px-1" style={{borderRadius: "50%", maxWidth: "25%"}} src={`https://plchldr.co/i/100?text=Amazon&bg=232F3E`} alt={show.show_name} />
                    )
                }
            </div>
            </div>
